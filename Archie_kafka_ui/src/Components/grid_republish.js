...
function Grid_Republish() {
  ...
  const delbtn = (params) => {
    ...
    const columnDefs =[
        ...
        {headerName:"Action",field:'Action',cellRendererFramework: (params) => <div><button className="action-btn" onClick={() => delbtn(params)}><AiFillDelete style={{color: 'red'}} className='s-icons'/></button>&nbsp;&nbsp;&nbsp;</div>, 
  ...
  return (
    <div>
    <div>
    <Search_Grid allSelected={allSelected} onSearchLink={onSearchLink} onSearchTopic={onSearchTopic}/>
    </div>
    <div className="ag-theme-alpine compo" style={{height: 500}}> 
    <AgGridReact 
